...
export const ROLE_PERMISSIONS: Record<string, PermissionMap> = {
  ...
  GUARD: {
    ...
    [AclResource.SOCIALS]: { view: false, create: false, update: false, delete: false },
  ...
  RESIDENTS: {
    ...
    [AclResource.SOCIALS]: { view: true, create: false, update: false, delete: false },
...
function allResources(val: boolean): PermissionMap {
  return {
    ...
    [AclResource.SOCIALS]: { view: val, create: val, update: val, delete: val },
